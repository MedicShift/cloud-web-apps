...
export class InitialSchema1777225134586 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('ADMIN', 'MANAGER', 'NURSE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "departments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying, "hospitalId" uuid NOT NULL, CONSTRAINT "PK_839517a681a86bb84cbcc6a1e9d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "schedule_entries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "date" date NOT NULL, "scheduleId" uuid NOT NULL, "userId" uuid NOT NULL, "shiftId" uuid NOT NULL, CONSTRAINT "PK_bfe848ea36c4b3d8a4b18ec82aa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."schedules_status_enum" AS ENUM('DRAFT', 'GENERATING', 'PUBLISHED', 'ARCHIVED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "schedule_entries" ADD CONSTRAINT "FK_004267153afad8f57c7cf1d5746" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "schedule_entries" ADD CONSTRAINT "FK_7c960b7cf8997e304659dda34c9" FOREIGN KEY ("shiftId") REFERENCES "shifts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "schedules" ADD CONSTRAINT "FK_51c6e8cae3082ba8e9de50958ab" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "schedules" DROP CONSTRAINT "FK_51c6e8cae3082ba8e9de50958ab"`,
    );
    await queryRunner.query(
      `ALTER TABLE "schedules" DROP CONSTRAINT "FK_988d54f0e9799fe0584ad291f1d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "schedule_entries" DROP CONSTRAINT "FK_7c960b7cf8997e304659dda34c9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "schedule_entries" DROP CONSTRAINT "FK_004267153afad8f57c7cf1d5746"`,
    );
    await queryRunner.query(
