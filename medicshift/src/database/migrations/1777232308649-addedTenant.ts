...
export class AddedTenant1777232308649 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tenants_tenanttype_enum" AS ENUM('hospital', 'school')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "shifts" DROP CONSTRAINT "FK_08ac1923228419c9523bca473cc"`);
        await queryRunner.query(`ALTER TABLE "departments" DROP CONSTRAINT "FK_0ce987364b9a455af2a739558ab"`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum_old" AS ENUM('ADMIN', 'MANAGER', 'NURSE')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" TYPE "public"."users_role_enum_old" USING "role"::"text"::"public"."users_role_enum_old"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'NURSE'`);
        ...
        await queryRunner.query(`ALTER TABLE "shifts" ADD "shiftType" "public"."shifts_shifttype_enum" NOT NULL`);
